          ...
          <div className="row my-5 ">
            ...
            <div className="col-md-6 col-lg-3 ">
              <CoursCard
                ...
                title={"Bootstrap"}
                link1={"https://maharatech.gov.eg/enrol/index.php?id=36"}
                coursname1={"LEARN Bootstrap"}
                link2={"https://maharatech.gov.eg/enrol/index.php?id=36"}
                coursname2={"LEARN Bootstrap"}
                link3={"https://maharatech.gov.eg/enrol/index.php?id=36"}
                coursname3={"LEARN Bootstrap"}
              />
            </div>
            <div className="col-md-6 col-lg-3 ">
              <CoursCard
                ...
                title={"JS&ES6"}
                link1={"https://maharatech.gov.eg/enrol/index.php?id=36"}
                coursname1={"LEARN Javascript"}
                link2={"https://maharatech.gov.eg/enrol/index.php?id=36"}
                coursname2={"LEARN Javascript"}
                link3={"https://maharatech.gov.eg/enrol/index.php?id=36"}
                coursname3={"LEARN Javascript"}
              />
            </div>
            <div className="col-md-6 col-lg-3 ">
              <CoursCard
                ...
                title={"React"}
                link1={"https://maharatech.gov.eg/enrol/index.php?id=36"}
                coursname1={"LEARN React"}
                link2={"https://maharatech.gov.eg/enrol/index.php?id=36"}
                coursname2={"LEARN React"}
                link3={"https://maharatech.gov.eg/enrol/index.php?id=36"}
                coursname3={"LEARN React"}
              />
            </div>
          </div>
        </div>
